...
\include{fragment_allgemein}

\include{fragment_opaal}

\include{fragment_cplusplus}

\include{fragment_interprozesskommunikation}

\include{fragment_nebenlaeufigkeit}

\include{fragment_netzwerk}

\include{fragment_scheduling}
